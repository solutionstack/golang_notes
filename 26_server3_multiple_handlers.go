...
func main() {
	...
	signal.Notify(stop, os.Interrupt) //notify into the channel on signint

	<-stop //wait for stop notice (i.e wait for data to be sent to the channel)
