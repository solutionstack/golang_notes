...
var palette = []color.Color{color.RGBA{55,255,0,0}, color.RGBA{0,100,0,1},
color.RGBA{25,255,100,1}}
//var palette = []color.Color{color.White, color.RGBA{44,100,255, 0xff}}
